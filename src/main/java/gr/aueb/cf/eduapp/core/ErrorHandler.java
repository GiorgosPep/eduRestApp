...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleFileUploadFile(FileUploadException e) {
    ...
    @ExceptionHandler(AuthenticationException.class)
        ...
        log.warn("Authenticatio failed. Message ={}", e.getMessage());String errorCode = switch (e) {
