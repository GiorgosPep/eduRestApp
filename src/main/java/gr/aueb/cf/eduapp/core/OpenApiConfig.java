        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                ...
                                Provides endpoints for managing teachers, users, and organizationaldata.
                                
                                Authentications & Authorization is done via JWT Bearer tokens.
